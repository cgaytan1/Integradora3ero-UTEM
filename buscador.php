...
<div class="row">
      <div class="col s12 m4 l3" style="background: rgba(0,0,0,0.3);"> 
		...
		<div class="divider"></div>
		  	<div class="section">
		    	<h5 style="text-align: center;">EXTRA</h5>
  			</div>
  		</div>
...
<?php
	...
	include 'conexion.php';
	$sentencia = "SELECT * FROM productos WHERE nombre LIKE '".$busca."%'";
...
/* Aquí debe de ir el mensaje de que no se encontraron resultados en la busqueda.
if () {
	echo "<p style='text-align: center;'>"; echo "No hay nada por aquí... :("; echo "</p>";
}
*/
?>
		</div>
